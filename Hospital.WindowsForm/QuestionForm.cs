...
namespace Hospital.WindowsForm
{
    public partial class QuestionForm : Form
    {
        ...
        private QuestionAnswerModelResult[] result;
        ...
        public QuestionForm(MyContext context)
        {
            ...
            ///};
            InitializeComponent();
            result = new QuestionAnswerModelResult[_listQuestions.Count];
        ...
        {
            UserAccount.Begin = DateTime.Now;
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            foreach (RadioButton rb in radioButtons)
            {
                ...
                if(rb.Checked)
                {
                    ...
                    {
                        result[indexQuestion] = new QuestionAnswerModelResult();
                    }
